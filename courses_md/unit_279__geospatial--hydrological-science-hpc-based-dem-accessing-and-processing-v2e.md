...
### PDF-DEM_Process_TWI
*Source file:* `Instructions_DP6_DEM_Process_TWI_v06.pdf`  ·  *type:* file
...
12. To begin, we will establish two folders: one for intermediate files, where we will 
...
24. Finally, run the next code and we will plot all the rasters we have created in this 
...
### introduction
*Source file:* `Instructions_DP6_DEM_Process_TWI_v06b.pdf`  ·  *type:* file
...
*URL:* https://github.com/I-GUIDE/hydroewd/blob/2025_Miniworkshop/Coursepage_DP6_DEM_Process_v2e.ipynb
