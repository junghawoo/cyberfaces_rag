...
**Description:** The Rosen Center for Advanced Computing (RCAC) is excited to share a short course, “Unveiling the Mystery of Deep Learning: Past, Present, and Future”. This course is designed to provide those who utilize artificial intelligence (AI) tools with a deeper understanding of the technology, allowing them to innovate in the field as well as optimize their workflows.
